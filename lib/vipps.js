...
const baseUrl = "https://apitest.vipps.no";

const clientId = process.env.VIPPS_CLIENT_ID;
const clientSecret = process.env.VIPPS_CLIENT_SECRET;
const subscriptionKey = process.env.VIPPS_SUBSCRIPTION_KEY_PRIMARY;
...
export async function initiatePaymentVipps(orderId, total, phoneNumber) {
