...
export const clientId = process.env.NEXT_PUBLIC_VIPPS_CLIENT_ID;
export const clientSecret = process.env.NEXT_PUBLIC_VIPPS_CLIENT_SECRET;
export const subscriptionKey =
  process.env.NEXT_PUBLIC_VIPPS_SUBSCRIPTION_KEY_PRIMARY;
export const merchantSerialNumber =
  process.env.NEXT_PUBLIC_VIPPS_MERCHANT_SERIAL_NUMBER;
